...
由于本人基础不牢，在第一次写题时，误将题目输入当作list列表，导致在pycharm中可以运行，而在leetcode中编译错误
...
a = Solution()
result = Solution.addTwoNumbers(a, l1=[8, 8, 8], l2=[2, 1, 1, 1])
print(result)  # [0, 0, 0, 2]
```

后增加了部分类的代码，即可在pycharm中编译调试
...
print(result)  # ListNode {val: 0, next: ListNode {val: 0, next: ListNode {val: 0, next: ListNode {val: 1, next: None}}}}
